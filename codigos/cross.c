...
#include <fcntl.h>                                                                                    
#include <sys/mman.h>                                                                                 
#include <unistd.h>                                                                                                                                                                                         #define GPIO_BASE 0x3F200000  // Endereço base do GPIO para Raspberry Pi 3                            
#define BLOCK_SIZE 4096                                                                                                                                                                                     #define GPFSEL2   0x08                                                                                
#define GPSET0    0x1C                                                                                
#define GPCLR0    0x28   
...
return 1;                                                                                         }                                                                                                                                                                                                           volatile uint32_t gpio = (volatile uint32_t *)mmap(                                                      
NULL,                                                                                                 
BLOCK_SIZE,                                                                                           
...
*(gpio + GPSET0/4) = 1 << 25;                                                                                                                                                                               printf("Teste alarmes");                                                                              
